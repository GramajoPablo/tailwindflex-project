...
export default function Home_() {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-around mt-16">
      {/* Column 1 */}
      <div className="max-w-sm mx-4 bg-white shadow-xl rounded-lg text-gray-900">
      ...
      {/* Column 2 (Clone of Column 1 for layout purposes) */}
      <div className="max-w-sm mx-4 bg-white shadow-xl rounded-lg text-gray-900">
        {/* Duplicate content for column 2 here */}
        <div className="max-w-sm mx-4 bg-white shadow-xl rounded-lg text-gray-900">
        <div className="rounded-t-lg h-32 overflow-hidden">
          <img className="object-cover object-top w-full" src='https://images.unsplash.com/photo-1549880338-65ddcdfd017b?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max&ixid=eyJhcHBfaWQiOjE0NTg5fQ' alt='Mountain' />
        </div>
